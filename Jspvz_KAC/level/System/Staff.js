...
oS.Init({
	...
	Staff_HTML: [
		...
		'',
		'<!-- 制作人 -->',
		'<a style="font-size:65px;-webkit-text-stroke-width:2px;">主要制作人</a><br>',
		'<a style="font-size:35px;line-height:1.3;">我是帅<br></a><br><a style="font-size:225px;"><br></a>',
		'',
		'<!-- 特别感谢 -->',
		'<a style="font-size:65px;-webkit-text-stroke-width:2px;">特别感谢</a><br>',
		'<a style="font-size:35px;line-height:2;word-spacing:1em;">snz jspvz低玩 WU师葵 白鹤亮翅<br>屏幕前的你</a><br><a style="font-size:225px;"><br></a>',
		'',
		'<!-- 音乐列表，可以点击音乐播放 -->',
