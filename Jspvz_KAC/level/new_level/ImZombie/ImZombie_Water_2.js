oS.Init({
	PName: [oSunFlower, oSnowPea, oHypnoShroom, oThreepeater, oSpikeweed, oStarfruit, oPlantern, oGarlic, oSplitPea, oGloomShroom, oMelonPult, oCabbage, oGatlingPea_Pro],
	ZName: [oFlagZombie, oPoleVaultingZombie, oConeheadZombie, oBucketheadZombie, oFootballZombie, oDuckyTubeZombie2, oDuckyTubeZombie3, oScreenDoorZombie, oNewspaperZombie, oDancingZombie, oBackupDancer],
	...
	RiddleAutoGrow: function() {
		Summon(Set_Level(oS.Plants_C, 0, 0, 0, [
			{"ID": "02", "Set_Num": 6, "CanWater": true}, 
			{"ID": "06", "Set_Num": 2, "CanWater": true}, 
			{"ID": "11", "Set_Num": 2, "CanWater": true}, 
			{"ID": "14", "Set_Num": 3, "CanWater": true}, 
			{"ID": "18", "Set_Num": 2, "CanWater": true}, 
			{"ID": "30", "Set_Num": 2, "CanWater": true}, 
			{"ID": "43", "Set_Num": 1, "CanWater": true}, 
			{"ID": "MP", "Set_Line": [2, 5], "CanWater": true}, 
			{"ID": "CC", "Set_Line": [3, 4], "CanWater": true}, 
			{"ID": "GP", "Set_Line": [2, 6], "CanWater": false}
		], [1, 1, 2, 2, 1, 1]));

		NewImg("iStripe", "images/interface/Stripe.png", "left:" + (GetX1X2(5 + 1)[0] - 11) + "px;top:65px", EDAll);
		for(let i = 1; i <= oS.R; i++) CustomSpecial(oBrains, i, 0);
	},
	StartGame: function() {
		oP.Monitor(), BeginCool();
		SetVisible($("dFlagMeter"), $("dFlagMeterContent"), $("dTop"));
		oS.RiddleAutoGrow(); oGd.MoveFogLeft();
