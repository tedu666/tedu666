oS.Init({
	...
	LoadAccess: function(start_game){
		...
		NewEle("Div_TimeTask", "div", "display:none;z-index:5;top:10px; left:315px; position:absolute;width:355px;height:35px;background:#000000BB;border-radius:12.5px;opacity:1;cursor:pointer;", {onclick: function(){PauseGamesShowBlock();}}, EDAll);
	...
	StartGame: function(){
		...
		PrepareGrowPlants(function() {
			...
			NewEle("DivTeach", "div", "pointer-events:none;", {innerHTML: "您可以点击上方灰白数据面板重新查看本关目标！"}, EDAll);
