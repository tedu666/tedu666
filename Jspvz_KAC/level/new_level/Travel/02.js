...
oS.Init({
	...
	StartGame: function(){
		...
		PrepareGrowPlants(function() {
			...
			NewEle("DivTeach", "div", "pointer-events:none;", {innerHTML: "小心，不要让僵尸踩到花坛！"}, EDAll);
	...
	FlagToEnd: function() {
		...
		NewImg("imgSF", "images/Card/Plants/GatlingPea.png", "left:627px;top:325px;clip:rect(auto,auto,60px,auto)", EDAll, {onclick: function() {GetNewCard(this, oGatlingPea_Pro, 0);}});
