oS.Init({
	...
	FlagToEnd: function() {
		...
		NewImg("imgSF", "images/Card/Plants/Torchwood.png", "left:627px;top:325px;clip:rect(auto,auto,60px,auto)", EDAll, {onclick: function() {GetNewCard(this, oTorchwood_Pro, 0);}});
