oS.Init({
	PName: [oSunFlower, oSnowPea, oHypnoShroom, oThreepeater, oSpikeweed, oStarfruit, oGarlic, oGloomShroom, oMelonPult, oCabbage],
	...
	RiddleAutoGrow: function() {
		...
		NewImg("iStripe", "images/interface/Stripe.png", "left:" + (GetX1X2(oS.Plants_C + 1)[0] - 11) + "px;top:65px", EDMove);
