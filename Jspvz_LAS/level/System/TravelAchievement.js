// 拓展关成就 SelectModal("System/TravelAchievement")
oS.Init({
	...
	Staff_HTML: [
		...
		'<a style="font-size:35px;line-height:1.5;word-spacing:1em;">snz jspvz低玩 WU师葵 白鹤亮翅<br>寒冰投手 B站的J lioumengqi<br>嘿嘿黑黑 SN0SE Dr・糕萌酸钾-Studio<br>屏幕前的你</a><br><a style="font-size:225px;"><br></a>',
		'',
		'<!-- 音乐列表，可以点击音乐播放 -->',
...
let DivPrompt = NewEle("DivPrompt", "div", "position:absolute;z-index:110;left:20px;top:560px;font-size:25px;font-family:Regular;color:rgb(255,255,255);white-space:pre;border-radius:8.5px;background:rgba(0,0,0,0.5);pointer-events:none;", {}, EDAll);
