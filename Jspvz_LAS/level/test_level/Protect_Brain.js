oS.Init({
	PName: [oPeashooter, oCherryBomb, oWallNut, oPotatoMine, oSnowPea, oChomper, oRepeater, oPuffShroom, oFumeShroom, oGraveBuster, oHypnoShroom, oScaredyShroom, oIceShroom, oDoomShroom, oLilyPad, oSquash, oThreepeater, oTangleKelp, oJalapeno, oSpikeweed, oTorchwood, oTallNut, oSeaShroom, oPlantern, oCactus, oBlover, oSplitPea, oStarfruit, oPumpkinHead, oFlowerPot, oCabbage, oMelonPult, oCoffeeBean, oGarlic, oSpikerock, oGatlingPea, oGloomShroom, oGatlingPea_Pro, oTorchwood_Pro, oCabbage_Pro, oMelonPult_Pro, oWinterMelon_Pro],
	...
	PicArr: ["images/Zombies/Zombie/1.gif", "new_skin/Images/InterFace/background_TF.jpg", "new_skin/Images/InterFace/background2_TF.jpg", "images/interface/background1unsodded2.jpg"],
	backgroundImage: "new_skin/Images/InterFace/background_TF.jpg",
	CanSelectCard: 1,
	DKind: 1,
	LevelName: "超乎寻常的战役",
	...
	LoadAccess: function(start_game){
		//load new bg
		NewImg("BackGround_TF_night", "new_skin/Images/InterFace/background2_TF.jpg", "opacity:0;left:-115", EDAll);
...
//		PlayMusic(oS.LoadMusic = oS.StartGameMusic);
		...
		PrepareGrowPlants(function() {
			...
			function() {
				oP.AddZombiesFlag();
				try{$("imgFlag2").style.left = "65px";}catch{};
	...
	AZ: [[oZombie, 3, 1], [oZombie2, 3, 1], [oZombie3, 4, 1], [oPoleVaultingZombie, 2, 1], 
	[oConeheadZombie, 4, 1], [oBucketheadZombie, 2, 1], [oNewspaperZombie, 3, 21, [1]], 
	[oScreenDoorZombie, 1, 21, [2]], [oFootballZombie, 2, 1], [oDancingZombie, 3, 23], 
	[oZomboni, 2, 56, [60,60,60,59]], [oJackinTheBoxZombie, 2, 41, [3,5,7,11,20,20]],
	[oSmallZombie, 1, 50, [1,1,1,1,1,1]], [oSmallConeheadZombie, 1, 50, [1,1]], [oSmallFootballZombie, 1, 50, [1]]],
	FlagNum: 60,
	FlagToSumNum: {
